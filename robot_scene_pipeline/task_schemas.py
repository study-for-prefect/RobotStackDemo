...
TASK_ACTION_SCHEMA = {
    ...
    "properties": {
        ...
        "selected_object_id": {"type": ["integer", "string"]},
        "target_object_ref": {"type": "string"},
        "target_object_track_id": {"type": "string"},
        "target_object_id": {"type": ["integer", "string"]},
        "target_object_label": {"type": "string"},
        "target_object_center_base_m": VECTOR3_SCHEMA,
        "contact_side": {"type": "string", "enum": ["+x", "-x", "+y", "-y"]},
        "direction_base": VECTOR3_SCHEMA,
        "distance_m": {"type": "number"},
        "gripper_yaw_rad": {"type": "number"},
        "safe_place_center_base_m": VECTOR3_SCHEMA,
        "role_id": ROLE_ID_SCHEMA,
        "group_id": {"type": "string"},
        "target_region_id": {"type": "string"},
...
TASK_ACTION_OUTPUT_SCHEMA = {
    ...
    "required": [
        ...
        "target_pose_base", "target_object_ref", "target_object_track_id",
        "target_object_id", "target_object_label", "target_object_center_base_m",
        "contact_side", "direction_base", "distance_m", "gripper_yaw_rad",
        "safe_place_center_base_m", "reason", "confidence",
    ],
    "properties": {
        "strategy_id": {"type": "string"},
        ...
        "contact_side": {"type": ["string", "null"], "enum": ["+x", "-x", "+y", "-y", None]},
        "direction_base": {
            "type": ["array", "null"], "items": {"type": "number"},
            "minItems": 3, "maxItems": 3,
        },
        ...
        "target_pose_base": {
            "type": ["object", "null"],
            "properties": {
                **TASK_ACTION_SCHEMA["properties"]["target_pose_base"]["properties"],
                "yaw_rad": {"type": ["number", "null"]},
            },
            "required": ["position_m", "yaw_rad"],
            "additionalProperties": False,
        },
        "reason": {"type": "string"},
        "confidence": {"type": "number", "minimum": 0.0, "maximum": 1.0},
